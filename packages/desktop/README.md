...
- The server address is set in-app: TopBar input + Apply (validated and held by the Rust side, persisted locally). The input defaults to `127.0.0.1:50051` but nothing is hardcoded at call time.
